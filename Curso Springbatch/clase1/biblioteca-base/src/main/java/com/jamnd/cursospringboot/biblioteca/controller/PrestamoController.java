...
public class PrestamoController {
    ...
    public PrestamoController(PrestamoService prestamoService, PrestamoMapper prestamoMapper) {
    ...
    public ResponseEntity<PrestamoResponse> crear(@Valid @RequestBody PrestamoRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(prestamoMapper.toResponse(creado));
    }
}
