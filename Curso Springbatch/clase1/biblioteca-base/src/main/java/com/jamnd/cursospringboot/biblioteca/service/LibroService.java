...
public class LibroService {
    ...
    public List<Libro> filtrarPorAutorYDisponibilidad(String autor, Boolean disponible) {
        boolean autorVacio = autor == null || autor.isBlank();

        if (autorVacio && disponible == null) {
            return listar();
        }
        if (!autorVacio && disponible == null) {
        ...
        return libroRepository.findByAutorContainingIgnoreCaseAndDisponible(autor, disponible);
    }
