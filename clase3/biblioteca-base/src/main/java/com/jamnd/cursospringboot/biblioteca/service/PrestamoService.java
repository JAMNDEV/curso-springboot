...
public class PrestamoService {
    ...
    public PrestamoService(LibroRepository libroRepository, AlumnoRepository alumnoRepository, PrestamoRepository prestamoRepository) {
    ...
    public Prestamo crearPrestamo(PrestamoRequest request) {
        // Validacion secuencial (lamina 27): existencia y disponibilidad de libro.
        ...
        // Validacion secuencial (lamina 27): existencia de alumno.
        ...
        // Regla de negocio (lamina 24 y 25): alumno con deudas no puede solicitar prestamo.
        ...
        // Regla de negocio: calcular fecha de devolucion.
        LocalDate fechaPrestamo = LocalDate.now();
        LocalDate fechaDevolucion = fechaPrestamo.plusDays(7);

        Prestamo prestamo = new Prestamo(null, libro.getId(), alumno.getId(), fechaPrestamo, fechaDevolucion);
        Prestamo guardado = prestamoRepository.save(prestamo);

        // Actualizacion de estado inventario despues de crear prestamo.
